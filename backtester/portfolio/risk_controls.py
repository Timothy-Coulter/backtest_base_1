...
class StopLossConfig:
    ...
    max_loss_value: float | None = None  # Maximum absolute loss allowed
    activation_price: float | None = None  # Price at which stop loss activates
...
class TakeProfitConfig:
    ...
    max_gain_value: float | None = None  # Maximum absolute gain target
    activation_price: float | None = None  # Price at which take profit activates
...
class StopLoss:
    ...
    def __init__(
        ...
        stop_loss_type: StopLossType | None = None,
        ...
        self.trigger_price: float | None = None  # Alias for triggered_price
        self.trigger_time: datetime | None = None  # Alias for triggered_timestamp
...
class TakeProfit:
    ...
    def __init__(
        ...
        partial_take_profit_levels: list[float] | None = None,
...
class RiskControlManager:
    ...
    def __init__(
        ...
        take_profit_config: TakeProfitConfig | None = None,
        logger: logging.Logger | None = None,
    ) -> None:
...
class PositionSizer:
    ...
    def calculate_position_size(
        self, portfolio_value: float, volatility: float = 0.0, conviction: float = 1.0
    ) -> float:
    ...
    def calculate_position_size_volatility_adjusted(
        ...
        base_position = self.calculate_position_size_percentage(
            account_value, entry_price, self.max_position_size
        )
    ...
    def calculate_position_size_correlation_adjusted(
        self, account_value: float, entry_price: float, portfolio_correlation: float
    ) -> float:
...
class RiskMonitor:
    ...
    def __init__(
        ...
        self.alert_thresholds = {'volatility': 0.30, 'drawdown': 0.15, 'leverage': 3.0}

    def add_risk_metric(
        self, metric_name: str, threshold: float, comparison: str = 'greater_than'
    ) -> None:
        """Add a risk metric to monitor."""
        self.risk_metrics[metric_name] = {'threshold': threshold, 'comparison': comparison}
    ...
    def add_alert_rule(self, metric: str, threshold: float, severity: str, action: str) -> None:
        ...
        self.alert_rules.append(
            {'metric': metric, 'threshold': threshold, 'severity': severity, 'action': action}
        )
