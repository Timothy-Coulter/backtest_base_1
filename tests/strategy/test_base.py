...
class TestBaseStrategy:
    ...
    def test_signal_to_dict(self):
        ...
        signal = Signal(timestamp=datetime.now(), signal_type="SELL", price=100.0)
    ...
    def test_signal_repr(self):
        ...
        signal = Signal(timestamp=datetime.now(), signal_type="BUY", price=100.0, quantity=5.0)
...
class TestDualPoolMovingAverageStrategy:
    ...
    def test_initialization_custom_params(self):
        ...
        strategy = DualPoolMovingAverageStrategy(
            name="CustomMA", ma_short=10, ma_long=30, leverage_base=2.0, leverage_alpha=4.0
        )
    ...
    def test_generate_signals_insufficient_data(self):
        ...
        data = pd.DataFrame(
            {'Close': [100, 101, 102], 'High': [105, 106, 107], 'Low': [99, 100, 101]}
        )
    ...
    def test_strategy_parameters(self):
        ...
        strategy = DualPoolMovingAverageStrategy(
            ma_short=10, ma_long=30, leverage_base=2.0, leverage_alpha=4.0
        )
    ...
    def test_leverage_allocation(self):
        ...
        strategy = DualPoolMovingAverageStrategy(leverage_base=2.0, leverage_alpha=3.0)
...
@pytest.mark.parametrize(
    "short_ma,long_ma,expected_trend",
    [(105, 100, "BULLISH"), (95, 100, "BEARISH"), (100.5, 100, "NEUTRAL"), (100, 100.5, "NEUTRAL")],
)
