...
class TestStopLoss:
    ...
    def test_initialization_price_based_stop_loss(self):
        ...
        stop_loss = StopLoss(
            stop_loss_type=StopLossType.PRICE, stop_loss_value=95.0, entry_price=100.0
        )
    ...
    def test_calculate_stop_price_price_based(self):
        ...
        stop_loss = StopLoss(stop_loss_type=StopLossType.PRICE, stop_loss_value=95.0)
...
class TestTakeProfit:
    ...
    def test_initialization_percentage_take_profit(self):
        ...
        take_profit = TakeProfit(take_profit_type=TakeProfitType.PERCENTAGE, take_profit_value=0.10)
    ...
    def test_initialization_price_based_take_profit(self):
        ...
        take_profit = TakeProfit(take_profit_type=TakeProfitType.PRICE, take_profit_value=110.0)
...
class TestPositionSizer:
    ...
    def test_initialization_custom_params(self):
        ...
        sizer = PositionSizer(max_position_size=0.20, min_position_size=0.005, risk_per_trade=0.015)
    ...
    def test_risk_based_position_sizing(self):
        ...
        assert (
            position_size
            <= (position_params['account_value'] * sizer.max_position_size)
...
class TestRiskMonitor:
    ...
    def test_initialization_custom_params(self):
        ...
        monitor = RiskMonitor(
            check_interval=30, enable_real_time_alerts=True, max_history_size=1000
        )
    ...
    def test_check_risk_metrics(self):
        ...
        portfolio_state = {'current_drawdown': 0.18, 'leverage': 2.8}
    ...
    def test_risk_alert_system(self):
        ...
        monitor.add_alert_rule(
            metric='drawdown', threshold=0.20, severity='critical', action='reduce_positions'
        )
...
@pytest.mark.parametrize(
    "stop_type,stop_value,entry_price,current_price,side,expected_trigger",
    [
...
def test_stop_loss_trigger_parametrized(
    stop_type, stop_value, entry_price, current_price, side, expected_trigger
):
...
@pytest.mark.parametrize(
    "risk_level,position_size,expected_action",
    [
