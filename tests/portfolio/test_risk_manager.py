...
class TestRiskManager:
    ...
    def test_stress_test_portfolio(self):
        ...
        for _scenario_name, scenario_result in stress_results['scenarios'].items():
    ...
    def test_check_risk_limits(self):
        ...
        manager = RiskManager(
            max_portfolio_var=0.05, max_drawdown=0.15, max_leverage=2.5, max_single_position=0.20
        )
    ...
    def test_risk_limit_violations(self):
        ...
        manager = RiskManager(max_portfolio_var=0.05, max_drawdown=0.15, max_leverage=2.5)
    ...
    def test_risk_budget_allocation(self):
        ...
        allocation = manager.allocate_risk_budget(assets, risk_budget, min_weight, max_weight)
    ...
    def test_risk_adjusted_position_sizing(self):
        ...
        assert (
            position_size <= (account_value * 0.25) / current_volatility
...
class TestExposureMonitor:
    ...
    def test_check_exposure_limits(self):
        ...
        monitor = ExposureMonitor(
            max_sector_exposure=0.30, max_country_exposure=0.60, max_industry_exposure=0.25
        )
    ...
    def test_dynamic_exposure_adjustment(self):
        ...
        market_conditions = {
            ...
            'sector_momentum': {'technology': 0.8, 'healthcare': 0.3, 'energy': -0.2},
        }

        # Current exposures
        current_exposures = {'technology': 0.50, 'healthcare': 0.20, 'energy': 0.15}
        ...
        if market_conditions['correlation_regime'] == 'elevated':
            assert adjustments['recommended_changes']['technology']['action'] in [
                'reduce',
                'maintain',
            ]
...
class TestRiskAttribution:
    ...
    def test_factor_attribution(self):
        ...
        factor_returns = {'market': 0.08, 'size': 0.03, 'value': 0.05}
        ...
        assert factor_contribution['factor_contributions']['market'] >= max(
            factor_contribution['factor_contributions'][f] for f in ['size', 'value']
        )
    ...
    def test_risk_attribution_decomposition(self):
        ...
        portfolio_data = {
            ...
            'correlation_matrix': pd.DataFrame(
                {'SPY': [1.0, 0.7, 0.6], 'AAPL': [0.7, 1.0, 0.8], 'GOOGL': [0.6, 0.8, 1.0]},
...
class TestRiskCompliance:
    ...
    def test_compliance_reporting(self):
        ...
        report = compliance.generate_compliance_report(
            reporting_period='Q4_2023', include_recommendations=True, include_trend_analysis=True
        )
...
@pytest.mark.parametrize(
    "var_level,expected_es_relation",
    [(0.95, "es_greater_than_var"), (0.99, "es_greater_than_var"), (0.90, "es_greater_than_var")],
)
...
@pytest.mark.parametrize(
    "concentration_level,risk_score_range",
    [
