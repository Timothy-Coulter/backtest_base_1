...
class TestDataHandler:
    ...
    def test_load_data_success(self):
        ...
        with patch('yfinance.download') as mock_yf:
            ...
            result = handler.load_data(
                symbol='SPY', start_date='2023-01-01', end_date='2023-01-05', interval='1d'
            )
    ...
    def test_multiple_symbols_loading(self):
        ...
        with patch('yfinance.download', side_effect=mock_download_single):
            results = handler.load_multiple_symbols(symbols, '2023-01-01', '2023-01-03', '1d')
    ...
    def test_data_aggregation(self):
        ...
        aggregated = handler.aggregate_data(
            minute_data, target_frequency='2min', aggregation_method='ohlcv'
        )
...
class TestDataLoader:
    ...
    def test_load_from_database(self):
        ...
        with patch('sqlite3.connect') as mock_connect, patch('pandas.read_sql') as mock_read_sql:
            mock_connection = Mock()
            mock_connect.return_value = mock_connection
            mock_read_sql.return_value = mock_data

            result = loader.load_from_database(
                'sqlite', 'test.db', 'SELECT * FROM prices WHERE symbol = ?', ['SPY']
            )
...
class TestDataValidator:
    ...
    def test_validate_volume_data(self):
        ...
        # Valid volume data
        valid_data = pd.DataFrame({'Close': [100, 101, 102], 'Volume': [1000000, 1100000, 1200000]})
...
class TestDataPreprocessor:
    ...
    def test_handle_missing_values(self):
        ...
        # Test interpolation
        interpolated_data = preprocessor.handle_missing_values(data_with_gaps, method='interpolate')
    ...
    def test_normalize_prices(self):
        ...
        price_data = pd.DataFrame({'Close': [100, 101, 102, 103, 104, 105, 106, 107, 108, 109]})
...
@pytest.mark.parametrize(
    "symbol,expected_source",
    [("SPY", "yahoo"), ("AAPL", "yahoo"), ("GOOGL", "yahoo"), ("BTC-USD", "crypto")],
)
...
@pytest.mark.parametrize(
    "frequency,expected_bars", [("1min", 60), ("5min", 12), ("15min", 4), ("1h", 1)]
)
